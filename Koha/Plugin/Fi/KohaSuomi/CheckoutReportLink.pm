package Koha::Plugin::Fi::KohaSuomi::CheckoutReportLink;
...
our $metadata = {
    ...
    maximum_version => '',
    version         => $VERSION,
    description     => 'Linkki lainatilastoraporttiin tietueen pääsivulla G1109',
};
...
sub intranet_js {
    ...
    my $js = read_file($plugin_fulldir .'js.js');
